...
export default class LoginForm extends Component {
  ...
  onSubmit(event) {
    ...
    } else this.setState({ invalidPhone: "" });

    if (this.state.pass.length < 6) {
      this.setState({ invalidPass: "Введите минимум 6 символов" });
    } else this.setState({ invalidPass: "" });
        ...
        <div className="form">
          <div className="form_col">
            <div className="form_row">
              ...
              />
              <p className="err">
                {this.state.onBlurChangeFirstName && this.state.firstName.length === 0
                  ? "Введите имя"
                  : null}
              </p>
            ...
            <div className="form_row">
              ...
              />
              <p className="err">
                {this.state.onBlurChangeSecondName && this.state.secondName.length === 0
                  ? "Введите фамилию"
                  : null}
              </p>
            ...
            <div className="form_row">
              ...
              />
              <p className="err">
                {this.state.onBlurChangePhone &&
                (this.state.phone.indexOf("_") !== -1 || this.state.phone.length === 0)
          ...
          <div className="form_col">
            <div className="form_row">
              ...
              />
              <p className="err">
                {this.state.onBlurChangeEmail && !this.state.email.match(regExp)
                  ? "Введите email"
                  : null}
              </p>
            ...
            <div className="form_row">
              ...
              />
              <p className="err">
                {this.state.onBlurChangePass && this.state.pass.length < 6
                  ? "Введите пароль"
                  : null}
              </p>
            ...
            <div className="form_row">
              ...
              />
              <p className="err">
                {this.state.onBlurChangePassAgain && this.state.passAgain !== this.state.pass
                  ? "Пароль не совпадает"
                  : null}
              </p>
          ...
          <div className="btn_field">
            <button title="Отправить" className="btn" type="Submit">
              Отправить
            </button>
          </div>
        </div>
